...
using SockAddr = Heco.WinDivert.Structs.SocketAddress;
...
public class RouteResolver
{
    ...
    private unsafe RouteResolver(IPAddress dstAddr, IPAddress? srcAddr, int? interfaceIndex)
    {
        ...
        var bestSrcSockAddr = new SockAddr();

        nint pSrcSockAddr = IntPtr.Zero;
        if (srcAddr != null)
        {
            var srcSockAddr = new SockAddr();
    ...
    private static int GetInterfaceIndex(ref SockAddr dstSockAddr)
    {
