...
public struct V4Header
{
    ...
    {
        readonly get => (FragmentFlag)((FragOff0 >> 13) & 0x7);
        set => FragOff0 = (ushort)((FragOff0 & 0x1FFF) | (((byte)value & 0x7) << 13));
    }

    public readonly ushort FragOff => (ushort)(FragOff0 & 0x1FFF);
    ...
    [FieldOffset(36)] public ushort TcpChecksum;
    ...
    [FieldOffset(24)] public ushort UdpLength;
    [FieldOffset(26)] public ushort UdpChecksum;

    [FieldOffset(20)] public byte   IcmpType;
    [FieldOffset(21)] public byte   IcmpCode;
    [FieldOffset(22)] public ushort IcmpChecksum;
    [FieldOffset(24)] public ushort IcmpIdentifier;
    [FieldOffset(26)] public ushort IcmpSequenceNumber;
